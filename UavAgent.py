...
def move_tracking_lqr(client, p_aim, v_aim, height, a_aim, duration, waited=False, vehicle_name=''):
    """
    ...
    move_by_acceleration_horizontal_yaw(client, a[0, 0], a[1, 0], height, yaw, duration, waited=waited, vehicle_name=vehicle_name)
